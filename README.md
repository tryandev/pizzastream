...
In a real world case, this would be a mistake and I have not included it the finished product.


3) **The Panel Seperator**
    - Zoomed in to the mockup, the line seperating the 3 panels appears to have be 1 pixel thick,
sitting between 2 pixels. When zoomed out, this looks like a 2 pixels thick with half the darkness.
I decided to go with 1 pixel darker version following the zoomed in version of the mockup.
